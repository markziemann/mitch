...
if (d==1) {
    ...
    for ( i in seq_len(resrows) ) {
        ...
        suppressWarnings(tbl <- kbl(mydat,format='pipe',caption=as.character(t(myres[i,1]))) %>%
            kable_styling("hover", full_width = FALSE) )
        ...
        suppressWarnings( tbl <- kbl(head(tops,n=20L), format='pipe', row.names=FALSE,caption="Top 20 genes",digits=100) %>%
                kable_styling("hover", full_width = FALSE))
        ...
        suppressWarnings( tbl <- kbl(tops, format='pipe', row.names=FALSE, caption="All member genes",digits=100) %>%
                kable_styling("hover", full_width = FALSE) )
...
topgenelist<-function(i) {
    ...
    suppressWarnings( tbl <- kbl(head(topgenes,n=20L), format='pipe', row.names=FALSE, caption="Top 20 genes", digits=100) %>%
        kable_styling("hover", full_width = FALSE) )
    ...
    suppressWarnings( tbl <- kbl(sss, format='pipe', row.names=TRUE, caption="All member genes", digits=100) %>%
        kable_styling("hover", full_width = FALSE) )
...
if (d!=1) {
    ...
    if ( d<3 ) {
        ...
        for ( i in seq_len(resrows )) {
            ...
            suppressWarnings( tbl <- kbl(mydat,format='pipe',digits=5,caption=as.character(t(myres[i,1]))) %>%
                    kable_styling("hover", full_width = FALSE) )
